        ...
        Cypress.Commands.overwrite('request', (originalFn, ...args) => {
            ...
            return Promise.all([
                ...
                return originalFn(...args).catch(async (e) => {
                    ...
                    this.collectorState.addLog([constants_1.default.LOG_TYPES.CYPRESS_REQUEST, log, constants_1.default.SEVERITY.ERROR]);
                    throw e;
                })
                    .then((response) => {
                    return Promise.all([
                        ...
                        this.collectorState.addLog([constants_1.default.LOG_TYPES.CYPRESS_REQUEST, log, constants_1.default.SEVERITY.SUCCESS]);
                        return response;
                    });
                });
            });
