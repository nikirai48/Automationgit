...
class LogCollectCypressIntercept extends LogCollectBase_1.default {
    register() {
        Cypress.Commands.overwrite('intercept', (originalFn, ...args) => {
            let message = '';
            if (typeof args[0] === "string" && constants_1.default.HTTP_METHODS.includes(args[0].toUpperCase())) {
            ...
            this.collectorState.addLog([constants_1.default.LOG_TYPES.CYPRESS_INTERCEPT, message, constants_1.default.SEVERITY.SUCCESS]);
