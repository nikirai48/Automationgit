...
class LogCollectCypressBrowserNetwork extends LogCollectBase_1.default {
    constructor(type, collectorState, config) {
        ...
        this.typeString = type === 'xhr' ? constants_1.default.LOG_TYPES.CYPRESS_XHR : constants_1.default.LOG_TYPES.CYPRESS_FETCH;
    ...
    register() {
        ...
        const getConsoleProps = (options) => { var _a; return ((_a = options.consoleProps) === null || _a === void 0 ? void 0 : _a.props) ? options.consoleProps.props : options.consoleProps; };
